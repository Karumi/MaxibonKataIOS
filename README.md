...
Karumi developers can consume zero or a positive number of maxibons. The Karumi team is composed by five engineers and everytime some of these engineers go to the kitchen, if is in the afternoon, they grab at least one maxibons as follows:
